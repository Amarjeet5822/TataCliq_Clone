...
function FooterBottom() {
  return (
    <div className='w-4/5 m-auto mb-2'>
      ...
      <div className='text-sm'>
        <p className='font-semibold'>Online Shopping: Fast & convenient with the click of a button</p>
        <div className='py-4 '>
      ...
      <div className='text-sm'>
        <p className='font-semibold'>Tata CLiQ FASHION Shopping App: just a few clicks on Android & iOS
        </p>
        <div className='py-4 '>
      ...
      <div className='text-sm'>
        <p className='font-semibold'>Tata CLiQ FASHION: The most genuine place for Fashion and Lifestylen</p>
        <div className='py-4 '>
